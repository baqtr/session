...
token = "7065007495:AAGTNBnccSUA0iy_zpPSXsjqvYGwsIWBxwU" #توكن البوت
...
async def start_msg(app, message):
      reply_markup = ReplyKeyboardMarkup(
        [
          [
            KeyboardButton ("بايروجرام 1️⃣"), KeyboardButton ("تيليثون2️⃣")
          ],
          [KeyboardButton ("لمحه عن البوت والمطور ✅")]
        ],
...
🔸 لبـدء استخـراج الجلسة، اختـر الجلسـة بالأسفل.
🔸 إذا كنـت تريـد أن يكون حسـابك في أمـان تام، فاختـر بايروجـرام 🛡️
🔸 إذا كـان رقمك حقيقـي، فاختـر تيليثون ☎️
